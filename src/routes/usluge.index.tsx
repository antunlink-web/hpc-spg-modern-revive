...
const services = [
  ...
  { icon: Wrench, title: "Obračun pričuve i godišnji programi", desc: "Redovan obračun pričuve, izrada godišnjih programa održavanja i praćenje njihove provedbe.", href: "/usluge/obracun-pricuve" },
